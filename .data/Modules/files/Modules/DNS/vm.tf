...
resource "azurerm_virtual_machine_extension" "extension" {
  ...
  settings = <<SETTINGS
 {
  "fileuris" :"['https://raw.githubusercontent.com/sajipoochira/TerraformModules/main/terraform/Modules/DNS/dnssetup.ps1']",
  "commandToExecute": "powershell.exe -ExecutionPolicy Unrestricted -File dnssetup.ps1"
 }
SETTINGS
